...
export default function Header() {
	...
	const avatar = (user && user.avatar) || '/assets/images/profile-1.png';
		...
		<>
			...
			<nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
				<div className="container _custom_container">
					...
					<button className="navbar-toggler bg-light" type="button" aria-controls="navbarSupportedContent" aria-expanded={navOpen} aria-label="Toggle navigation" onClick={() => setNavOpen((open) => !open)}> <span className="navbar-toggler-icon"></span>
					</button>
					<div className={navOpen ? 'collapse navbar-collapse show' : 'collapse navbar-collapse'} id="navbarSupportedContent">
						...
						<ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
							...
							<li className="nav-item _header_nav_item" ref={notifyRef}>
								<span id="_notify_btn" className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifyOpen((open) => !open)}>
									...
									<div id="_notify_drop" className={notifyOpen ? '_notification_dropdown show' : '_notification_dropdown'} onClick={(e) => e.stopPropagation()}>
						...
						<div className="_header_nav_profile" ref={profileRef}>
							...
							<div className="_header_nav_dropdown">
								...
								<button id="_profile_drop_show_btn" className="_header_nav_dropdown_btn _dropdown_toggle" type="button" onClick={() => setProfileOpen((open) => !open)}>
							...
							{/* dropdown */}
							<div id="_prfoile_drop" className={profileOpen ? '_nav_profile_dropdown _profile_dropdown show' : '_nav_profile_dropdown _profile_dropdown'}>
